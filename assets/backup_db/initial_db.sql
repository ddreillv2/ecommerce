...
CREATE TABLE IF NOT EXISTS `autoposting` (
  ...
  `wordpress_blog_url` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `messenger_bot` (
  ...
  `template_type` enum('text','image','audio','video','file','quick reply','text with buttons','generic template','carousel','media','One Time Notification') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
...
CREATE TABLE IF NOT EXISTS `sms_api_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `gateway_name` enum('planet','plivo','twilio','clickatell','clickatell-platform','nexmo','msg91.com','textlocal.in','sms4connect.com','telnor.com','mvaayoo.com','routesms.com','trio-mobile.com','sms40.com','africastalking.com','infobip.com','smsgatewayme','semysms.net','custom') CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ecommerce_cart` (
  ...
  `checkout_account_email` varchar(255) NOT NULL,
  `checkout_account_receiver_email` varchar(255) NOT NULL,
  `checkout_account_country` varchar(100) NOT NULL,
  `checkout_account_first_name` varchar(255) NOT NULL,
  `checkout_account_last_name` varchar(255) NOT NULL,
  ...
  `payment_temp_session` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ecommerce_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `store_unique_id` varchar(255) NOT NULL,
  `user_id` int(11) NOT NULL,
  `page_id` int(11) NOT NULL,
  `store_name` varchar(255) NOT NULL,
  `store_logo` varchar(255) NOT NULL,
  `store_favicon` varchar(255) NOT NULL,
  ...
  `notification_configure_email_table` varchar(255) NOT NULL,
