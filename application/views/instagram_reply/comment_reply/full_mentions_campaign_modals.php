                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12">
                          <div class="custom-control custom-radio">
                        	...
                        	<label class="custom-control-label" for="full_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                          </div>
                          <div class="custom-control custom-radio">
                        	<input type="radio" name="full_message_type" value="filter" id="full_filter" class="custom-control-input radio_button">
                        	<label class="custom-control-label" for="full_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                          </div>
                        </div>
                            ...
                            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <span class='float-right'>
                              	...
                              	<div class="clearfix"></div>
                                	<textarea class="form-control full_message" name="full_generic_message" id="full_generic_message" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        	</div>
                        </div>
                        ...
                        <div class="col-12" id="full_filter_message_div" style="display: none;">
                            ...
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                ...
                                <div class="form-group" id="full_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 10px; margin-bottom: 50px;">
                                    ...
                                    <label><?php echo $this->lang->line("Message for comment reply") ?><span class="red">*</span>
                                    ...
                                    <span class='float-right'>
                                      ...
                                      <div class="clearfix"></div>
                                    <textarea class="form-control full_message" name="full_comment_reply_msg_<?php echo $i; ?>" id="full_comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                                </div>
                            <?php endfor; ?>
                            ...
                            <div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <textarea class="form-control full_message" name="full_nofilter_word_found_text" id="full_nofilter_word_found_text" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="padding: 10px 20px 10px 20px;">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="full_edit_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input type="radio" name="full_edit_message_type" value="filter" id="full_edit_filter" class="custom-control-input radio_button">
                            <label class="custom-control-label" for="full_edit_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12" id="full_edit_generic_message_div" style="display: none;">
                        ...
                        <span class='float-right'>
                            ...
                            <div class="clearfix"></div>
                            <textarea class="form-control full_message" name="full_edit_generic_message" id="full_edit_generic_message" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        </div>
                    ...
                    <div class="col-12" id="full_edit_filter_message_div" style="display: none;">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            ...
                            <div class="form-group" id="full_edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 10px; margin-bottom: 50px;">
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control full_message" name="full_edit_comment_reply_msg_<?php echo $i; ?>" id="full_edit_comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                            </div>
                        <?php endfor; ?>
                        ...
                        <div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 10px;">
                            ...
                            <textarea class="form-control full_message" name="full_edit_nofilter_word_found_text" id="full_edit_nofilter_word_found_text" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row" style="padding: 10px 20px 10px 20px;">
                        ...
                        <div class="col-12">
                          <div class="custom-control custom-radio">
                        	...
                        	<label class="custom-control-label" for="mentions_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                          </div>
                          <div class="custom-control custom-radio">
                        	<input type="radio" name="mentions_message_type" value="filter" id="mentions_filter" class="custom-control-input radio_button">
                        	<label class="custom-control-label" for="mentions_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                          </div>
                        </div>
                        ...
                        <div class="col-12" id="mentions_generic_message_div" style="display: none;">
                            ...
                            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <span class='float-right'>
                              	...
                              	<div class="clearfix"></div>
                                	<textarea class="form-control mentions_message" name="mentions_generic_message" id="mentions_generic_message" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        	</div>
                        </div>
                        ...
                        <div class="col-12" id="mentions_filter_message_div" style="display: none;">
                            ...
                            <?php for ($i = 1; $i <= 20; $i++) : ?>
                                ...
                                <div class="form-group" id="mentions_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 10px; margin-bottom: 50px;">
                                    ...
                                    <span class='float-right'>
                                      ...
                                      <div class="clearfix"></div>
                                    <textarea class="form-control mentions_message" name="mentions_comment_reply_msg_<?php echo $i; ?>" id="mentions_comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                                </div>
                            <?php endfor; ?>
                            ...
                            <div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 10px;">
                                ...
                                <textarea class="form-control mentions_message" name="mentions_nofilter_word_found_text" id="mentions_nofilter_word_found_text" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="padding: 10px 20px 10px 20px;">
                    ...
                    <div class="col-12">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="mentions_edit_generic"><?php echo $this->lang->line("generic message for all") ?></label>
                        </div>
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="mentions_edit_filter"><?php echo $this->lang->line("send message by filtering word/sentence") ?></label>
                        </div>
                    </div>
                    ...
                    <div class="col-12" id="mentions_edit_generic_message_div" style="display: none;">
                        ...
                        <span class='float-right'>
                            ...
                            <div class="clearfix"></div>
                            <textarea class="form-control mentions_message" name="mentions_edit_generic_message" id="mentions_edit_generic_message" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        </div>
                    ...
                    <div class="col-12" id="mentions_edit_filter_message_div" style="display: none;">
                        ...
                        <?php for ($i = 1; $i <= 20; $i++) : ?>
                            ...
                            <div class="form-group" id="mentions_edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 10px; margin-bottom: 50px;">
                                ...
                                <div class="clearfix"></div>
                                <textarea class="form-control mentions_message" name="mentions_edit_comment_reply_msg_<?php echo $i; ?>" id="mentions_edit_comment_reply_msg_<?php echo $i; ?>" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                            </div>
                        <?php endfor; ?>
                        ...
                        <div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 10px;">
                            ...
                            <textarea class="form-control mentions_message" name="mentions_edit_nofilter_word_found_text" id="mentions_edit_nofilter_word_found_text" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
                        </div>
                    </div>
                </div>
            </div>
