...
<html lang="en">
  <head>    
    ...
    <title>Email Template Builder - XeroChat</title>
    ...
    <script>
        ...
        window.ddetb_vars = {
            ...
            template_placeholder: '<?php echo $this->lang->line("Name your template"); ?>', 
  ...
  <body>
    <div class="container-fullscreen">
        ...
        <div class="container text-center">
            <div id="choose-template" class="text-center d-none">
                <button class="choose" type="button" data-id="no-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/no-sidebar.jpg'); ?>" class="img-fluid" alt=""><p>No Sidebar (wide)</p></button>
                <button class="choose" type="button" data-id="left-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/left-sidebar.jpg'); ?>" class="img-fluid" alt=""><p>Left Sidebar</p></button>
                <button class="choose" type="button" data-id="right-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/right-sidebar.jpg'); ?>" class="img-fluid" alt=""><p>Right Sidebar</p></button>
                <button class="choose" type="button" data-id="both-sidebar"><img src="<?php echo base_url('plugins/email-template-builder/img/both-sidebar.jpg'); ?>" class="img-fluid" alt=""><p>Both Sidebars</p></button>
            </div>
        </div>
    ...
    <button class="btn btn-info btn-left-bottom-1 d-none" type="button" id="setting" title="Layout options" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-cog fa-spin"></i></button>

    <button class="btn btn-warning btn-left-bottom-2 d-none" type="button" id="save-and-quit" title="Save and Quit" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-sign-out"></i></button>

    <button class="btn btn-primary btn-left-bottom-3 d-none" type="button" id="save-only" title="Save template" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-hdd-o"></i></button>

    <button class="btn btn-success btn-left-bottom-4 d-none" type="button" id="preview" title="Preview" data-toggle="tooltip" data-placement="top" data-trigger="hover"><i class="fa fa-search-plus"></i></button>
