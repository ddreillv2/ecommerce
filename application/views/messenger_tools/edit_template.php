                          ...
                          <div class="row" id="list_with_buttons_row">
                             ...
                             <div class="col-4">
                                <div class="form-group">
                                   ...
                                   <select class="form-control select2 list_with_button_type_class" id="list_with_button_type_<?php echo $k; ?>" name="list_with_button_type_<?php echo $k; ?>">
                                      ...
                                      <option value="web_url_email" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][0]['url']) && strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_email') !== false) echo 'selected'; ?> ><?php echo $this->lang->line("User's Email"); ?></option>
                                      <option value="web_url_phone" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][0]['url']) && strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_phone') !== false) echo 'selected'; ?> ><?php echo $this->lang->line("User's Phone"); ?></option>
                                      <option value="web_url_location" <?php if(isset($full_message[$k]['attachment']['payload']['buttons'][0]['url']) && strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_location') !== false) echo 'selected'; ?> ><?php echo $this->lang->line("User's Location"); ?></option>
                             ...
                             <div class="col-4">
                                <div class="form-group" id="list_with_button_postid_div_<?php echo $k; ?>" <?php if(!isset($full_message[$k]['attachment']['payload']['buttons'][0]['payload']) || $full_message[$k]['attachment']['payload']['buttons'][0]['type'] != 'postback') echo 'style="display: none;"'; ?> >
                                  ...
                                  <div <?php if($input_type == 'hidden') echo "style='display:none;'"; ?>>
                                   <select class="form-control push_postback select2 this_page-dropdown-item" name="list_with_button_post_id_<?php echo $k; ?>" id="list_with_button_post_id_<?php echo $k; ?>">
                                     <?php 
                                ...
                                <div class="form-group" id="list_with_button_web_url_div_<?php echo $k; ?>" <?php if(!isset($full_message[$k]['attachment']['payload']['buttons'][0]['url']) || (isset($full_message[$k]['attachment']['payload']['buttons'][0]['url']) && (strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_birthdate') !== false || strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_email') !== false || strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_phone') !== false || strpos($full_message[$k]['attachment']['payload']['buttons'][0]['url'],'webview_builder/get_location') !== false))) echo 'style="display: none;"'; ?> >
                                   <label><?php echo $this->lang->line("Web Url"); ?></label>
