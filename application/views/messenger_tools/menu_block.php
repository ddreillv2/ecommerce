 ...
 <section class="section">
  ...
  <div class="section-body">
    <div class="row">
      ...
      <?php 
      if($this->basic->is_exist("modules",array("id"=>280))) :
      if($this->session->userdata('user_type') == 'Admin' || in_array(280,$this->module_access)) : ?>
      <div class="col-lg-6">
        <div class="card card-large-icons">
          <div class="card-icon text-primary">
          ...
          <div class="card-body">
            <h4><?php echo $this->lang->line("Messenger Appointment Booking"); ?></h4>
            <p><?php echo $this->lang->line("Complete appointment booking system inside Messenger"); ?></p>
            
            <div class="dropdown">
              <a href="<?php echo base_url('appointment_booking'); ?>"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
            </div>
      ...
      <?php 
      if($this->basic->is_exist("modules",array("id"=>268))) :
      ...
      <div class="col-lg-6">
        <div class="card card-large-icons">
          ...
          <div class="card-body">
            <h4><?php echo $this->lang->line("Messenger E-commerce Store"); ?></h4>
            <p><?php echo $this->lang->line("Complete e-commerce platform inside Messenger"); ?></p>
            
            <div class="dropdown">
              <a href="#" data-toggle="dropdown" class="no_hover" style="font-weight: 500;"><?php echo $this->lang->line("Actions"); ?> <i class="fas fa-chevron-right"></i></a>
              <div class="dropdown-menu">
                <a class="dropdown-item has-icon" href="<?php echo base_url('ecommerce'); ?>"><i class="fas fa-store-alt"></i> <?php echo $this->lang->line("Stores"); ?></a>
                <a class="dropdown-item has-icon" href="<?php echo base_url('ecommerce/payment_accounts'); ?>"><i class="fas fa-credit-card"></i> <?php echo $this->lang->line("Payment Accounts"); ?></a>               
              </div>
            </div>
