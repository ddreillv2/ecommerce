...
class Sms_email_manager extends Home
{
    ...
    public function contacts_total_emails()
    {
        ...
        $total_contact_with_email = count($wtihEmail);
        $total_contact = count($contacts_id);
    ...
    public function create_custom_api_post_method()
    {
     ...
     $this->ajax_check();
        ...
        if ($custom_post_api_name == '' || $custom_post_api_base_url == ''  ) {
           ...
           $post_data= array("key"=>$key,"value"=>$value,"type"=>$type);
    ...
    {   
        ...
        if (null != $id && $id > 0) {
            ...
            $content = $this->basic->get_data('email_sms_template', $where, ['id', 'user_id', 'content', 'location_hash', 'template_name'], '', 1);
            ...
            $data = [
                ...
                'mailTemplateData' => $mailTemplateHtml,
            ];
        }
        ...
        for($i = 0; $i < count($info); $i++)
        {
            ...
            if('drag_and_drop' == $editor_type) {
                ...
                $refinedEmailTemplateData = isset($content_array['refinedMailTemplateHtml']) 
                    ...
                    : '';
                $refinedEmailTemplateData = json_encode($refinedEmailTemplateData);

                $info[$i]['actions'] = "<div><a href='#' data-toggle='tooltip' title='".$this->lang->line("View Template")."' class='btn btn-circle btn-outline-primary view-emial-template' data-email-template-data='" . $refinedEmailTemplateData . "'><i class='fas fa-eye'></i></a>&nbsp;&nbsp;";
