...
class Ultrapost extends Home
{
    ...
    public function text_image_link_video_auto_post_list_data()
    {
        ...
        $select = array("facebook_rx_auto_post.*","facebook_rx_fb_page_info.page_id AS pageid","facebook_rx_fb_group_info.group_id as groupid");
        ...
        {   
            ...
            if($posting_status == '2'  && ($schedule_type == 'later' && $parent_id == '0' && $is_all_posted=='0' )) {
                $completed = ($posting_status == '2') ? ($completed_child_count+1) : $completed_child_count;
                $total = $count_allschedulepost_check+1;
