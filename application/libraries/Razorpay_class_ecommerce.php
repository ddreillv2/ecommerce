	...
	function set_button(){
		...
		/*
			...
			<script
			    ...
			    data-buttontext='{$razorpay_lang}'
			    data-name='{$this->title}'
			    data-description='{$this->description}'
			    data-image='{$this->img_url}'
			    data-prefill.name='{$this->customer_name}'
			    data-prefill.email='{$this->customer_email}'
			    data-prefill.contact='{$this->customer_phone}'
		...
		*/
		...
		$button="";
		// $button.='<script src="https://checkout.razorpay.com/v1/checkout.js"></script>';
		$button.="<button id='rzp-button1'>{$razorpay_lang}</button>";
