    ...
    $("#save-and-quit").on('click touchstart',function(e) {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                ...
                var swalInputContent = {
                        element: "input",
                        attributes: {
                            placeholder: ddetb.template_placeholder,
                            type: "text",
                            value: ddetb.templateName ? ddetb.templateName : '',
                ...
                var sweetAlert = swal({
                    ...
                    console.log('Here', willUpdate);

                    if (null !== willUpdate && template_name) {
